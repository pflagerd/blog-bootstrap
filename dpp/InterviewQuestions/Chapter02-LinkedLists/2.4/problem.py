...
class SinglyLinkedListNode:
    ...
    def generate(n: int = 0) -> SinglyLinkedListNode | None:
        return SinglyLinkedListNode.generate_K(n)
...
class Tests(unittest.TestCase):
    ...
    # Delete Middle Node: Implement an algorithm to delete a node in the middle (i.e., any node but the first and last node, not necessarily the exact middle) of a singly linked list, given only access that node.
    # EXAMPLE
    # Input:the node c from the linked list a->b->c->d->e->f
    # Result: nothing is returned, but the new linked list looks like a->b->d->e->f
    # Hints:#72
    @staticmethod
    def delete_middle_node_A(singly_linked_list_node):
        while True:
            if singly_linked_list_node is None:
                return
            if singly_linked_list_node.next is None:
                return
            singly_linked_list_node.value = singly_linked_list_node.next.value
            if singly_linked_list_node.next.next is None:
                singly_linked_list_node.next = None
                break
    ...
    delete_middle_node = delete_middle_node_A

    def test_delete_middle_node_A_10(self):
#        print(f"SinglyLinkedListNode.delete_middle_node_A(4).dumps() == '{SinglyLinkedListNode.delete_middle_node_A(4).dumps()}'")
        middle_of_list = SinglyLinkedListNode(2, SinglyLinkedListNode(3))
        start_of_list = SinglyLinkedListNode(0, SinglyLinkedListNode(1, middle_of_list))

        #self.assertEqual('{"next": {"next": {"next": {"next": null, "value": 3}, "value": 2}, "value": 1}, "value": 0}', start_of_list.dumps())

        Tests.delete_middle_node_A(middle_of_list)
        self.assertEqual('{"next": {"next": {"next": null, "value": 3}, "value": 1}, "value": 0}', start_of_list.dumps())

    def test_delete_middle_node_A_20(self):
        n = 10
        start_of_list = SinglyLinkedListNode.generate(n)
        middle_of_list = start_of_list
        for i in range(5):
        ...
        Tests.delete_middle_node_A(middle_of_list)
        print(start_of_list.dumps())
        self.assertEqual('{"next": {"next": {"next": {"next": {"next": {"next": {"next": {"next": {"next": null, "value": 9}, "value": 8}, "value": 7}, "value": 6}, "value": 4}, "value": 3}, "value": 2}, "value": 1}, "value": 0}', start_of_list.dumps())
